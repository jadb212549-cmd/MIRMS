...
export const AdminDashboardView: React.FC<AdminDashboardViewProps> = ({
  ...
  const [activeAdminSubTab, setActiveAdminSubTab] = useState<
    'OVERVIEW' | 'APPROVAL_QUEUE' | 'DASHBOARD_VISIBILITY' | 'CATEGORIES' | 'FORM_TEMPLATES' | 'SHARED_SYNC' | 'EXCEL' | 'CUSTOM_FIELDS' | 'AUDIT' | 'BACKUP' | 'SETTINGS' | 'USER_ACCESS'
  >(
                ...
                <label className="flex items-center gap-2 cursor-pointer bg-[#1A1A1A] px-3.5 py-2 rounded-xl border border-[#2A2A2A] text-xs font-medium text-gray-200">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setSyncEnabled(val);
                      handleAutoSave({ sharedFolderSyncEnabled: val });
                    }}
                  ...
                  <div className="flex items-center gap-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        onBlur={() => handleAutoSave({ dataDirectory: sharedFolderPath.trim() })}
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      handleAutoSave({ autoSyncIntervalSec: val });
                    }}
